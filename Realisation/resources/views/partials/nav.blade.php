    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <ul class="hidden md:flex space-x-8 text-gray-700 font-medium">
                <li><a href="{{ route('home') }}" class="hover:text-purple-600 transition ">Accueil</a></li>
                <li><a href="{{ route('about') }}" class="hover:text-purple-600 transition ">À propos</a></li>
                <li><a href="{{ route('projects.index') }}" class="hover:text-purple-600 transition ">Projets</a></li>
            </ul>
